...
- Upstream version: 1.6.0
- License: MIT (confirmed)
- Relationship: Adapted -- change selection, completion checks, delta-spec sync decision, and archive move preserved unchanged; `CE_OPENSPEC_STORE` made mandatory, delta-spec path explicitly store-rooted, guardrails added.

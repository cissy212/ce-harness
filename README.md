...
- [docs/workflow-guide.md](docs/workflow-guide.md) — what each workflow step does, reasoning lenses, mutation/Docker safety, how retrieval and project-local knowledge work, how `/adversarial-review` isolates itself from `/apply`'s own reasoning
